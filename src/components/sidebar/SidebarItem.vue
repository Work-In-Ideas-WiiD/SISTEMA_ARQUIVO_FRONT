...
<template>
  ...
  >
    <div class="icon-wrapper">
      ...
      <svg v-else-if="icon === 'plans'" width="25" height="25" viewBox="0 0 24 24" fill="currentColor">
        <path d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z"/>
      </svg>
      <svg v-else-if="icon === 'subscription'" width="25" height="25" viewBox="0 0 24 24" fill="currentColor">
