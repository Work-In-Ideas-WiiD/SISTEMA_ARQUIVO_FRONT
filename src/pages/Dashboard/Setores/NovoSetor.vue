...
<template>
  <section class="novo-setor">
    <div class="novo-setor__heading">
      <button
        type="button"
        class="novo-setor__back"
        aria-label="Voltar para Setores"
        @click="goBack"
      >
        <img :src="iconChevronLeft" width="24" height="24" alt="" />
      </button>
      <h2 class="novo-setor__title dashboard_title">NOVO SETOR</h2>
    </div>

    <div class="novo-setor__panel">
      <form class="novo-setor__form" @submit.prevent="handleSubmit">
        <div v-if="isAdmin" class="novo-setor__field">
          <span class="novo-setor__label night-field-label" id="empresa-label">EMPRESA*</span>
          <div ref="empresaFilterRef" class="novo-setor__select">
            <button
              type="button"
              class="novo-setor__select-trigger"
            ...
            >
              ...
              <img
                class="novo-setor__select-chevron"
                :class="{ 'novo-setor__select-chevron--open': empresaOpen }"
                :src="iconChevronDown"
                width="16"
                height="9"
                alt=""
            ...
            >
              <li>
                <button
                  type="button"
                  class="novo-setor__select-option"
                  role="option"
        ...
        <div class="novo-setor__field">
          <label class="novo-setor__label night-field-label" for="nome">NOME*</label>
          <input
            id="nome"
            v-model="form.nome"
            type="text"
            class="novo-setor__input"
        ...
        <div class="novo-setor__field">
          <label class="novo-setor__label night-field-label" for="descricao">DESCRIÇÃO</label>
          <textarea
            id="descricao"
            v-model="form.descricao"
            class="novo-setor__textarea"
            placeholder="Descrição do setor (opcional)"
            rows="4"
          />
        </div>

        <div class="novo-setor__actions">
          <button type="button" class="novo-setor__cancel" @click="goBack">
            CANCELAR
          </button>
          <button type="submit" class="novo-setor__submit" :disabled="loading">
