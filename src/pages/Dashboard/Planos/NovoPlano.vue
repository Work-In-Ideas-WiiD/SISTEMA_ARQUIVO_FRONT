...
<template>
  <section class="novo-plano">
    <div class="novo-plano__heading">
      <button
        type="button"
        class="novo-plano__back"
        aria-label="Voltar para Planos"
        @click="goBack"
      >
        <img :src="iconChevronLeft" width="24" height="24" alt="" />
      </button>
      <h2 class="novo-plano__title dashboard_title">NOVO PLANO</h2>
    </div>

    <div class="novo-plano__panel">
      <form class="novo-plano__form" @submit.prevent="handleSubmit">
        <div class="novo-plano__field">
          <label class="novo-plano__label night-field-label" for="nome">NOME*</label>
          <input
            id="nome"
            v-model="form.nome"
            type="text"
            class="novo-plano__input"
        ...
        <div class="novo-plano__field">
          <label class="novo-plano__label night-field-label" for="descricao">DESCRIÇÃO</label>
          <textarea
            id="descricao"
            v-model="form.descricao"
            class="novo-plano__textarea"
            placeholder="Descrição (opcional)"
            rows="4"
          />
        </div>

        <div class="novo-plano__row">
          <div class="novo-plano__field">
            <label class="novo-plano__label night-field-label" for="valor">VALOR MENSAL (R$)*</label>
            <input
              id="valor"
          ...
          <div class="novo-plano__field">
            <label class="novo-plano__label night-field-label" for="max_usuarios">MÁX. USUÁRIOS*</label>
            <input
              id="max_usuarios"
        ...
        <div class="novo-plano__row">
          <div class="novo-plano__field">
            <label class="novo-plano__label night-field-label" for="armazenamento">ARMAZENAMENTO (GB)*</label>
            <input
              id="armazenamento"
          ...
          <div class="novo-plano__field">
            <span class="novo-plano__label night-field-label" id="status-label">STATUS</span>
            <div ref="statusRef" class="novo-plano__select">
              <button
                type="button"
                class="novo-plano__select-trigger"
              ...
              >
                ...
                <img
                  class="novo-plano__select-chevron"
                  :class="{ 'novo-plano__select-chevron--open': statusOpen }"
                  :src="iconChevronDown"
                  width="16"
                  height="9"
                  alt=""
              ...
              >
                <li>
                  <button
                    type="button"
                    class="novo-plano__select-option"
                    role="option"
        ...
        <div class="novo-plano__actions">
          <button type="button" class="novo-plano__cancel" @click="goBack">
            CANCELAR
          </button>
          <button type="submit" class="novo-plano__submit" :disabled="loading">
