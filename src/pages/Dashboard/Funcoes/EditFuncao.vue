...
import { getFuncao, patchFuncao } from '@/services/http/funcoes'
...
async function handleSubmit() {
  ...
  try {
    loading.value = true
    await patchFuncao(form.value, route.params.id as string)
...
<template>
  <section class="form_section">
    <h2 class="title dashboard_title">EDITAR FUNÇÃO</h2>
