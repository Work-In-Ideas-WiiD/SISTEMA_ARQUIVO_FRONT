...
import { postFuncionario, type IPostFuncionarioModel } from '@/services/http/funcionarios'
...
async function handleSubmit() {
  ...
  try {
    loading.value = true
    const payload: IPostFuncionarioModel & { telefone?: string; data_nascimento?: string } = {
...
<template>
  <section class="novo-funcionario">
    <div class="novo-funcionario__heading">
      ...
      <h2 class="novo-funcionario__title dashboard_title">NOVO FUNCIONÁRIO</h2>
    </div>

    <div v-if="loadingData" class="novo-funcionario__loading">
      <p>Carregando…</p>
    </div>
